...
5. In the **Create stak** screen select the following options:
   ...
   4. Press on the  **Chose file** button and select the [Cloud9](https://github.com/eliranbi/AWSCloudFormation/blob/main/code/Cloud9_CloudFormation_Template.yaml) **Cloud9_CloudFormation_Template.yaml** file and press the **Open** button
